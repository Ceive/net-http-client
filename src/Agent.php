...
namespace Ceive\Net\HttpClient {
	...
	use Ceive\Net\HttpClient\CacheManager\CacheManager;
	use Ceive\Net\HttpClient\CookiesManager\CookiesManagerInterface;
	
	use Ceive\Net\HttpFoundation\BrowserInterface;
	use Ceive\Net\HttpFoundation\ClientInterface;
	
	use Ceive\Net\HttpFoundation\ResponseInterface;
	use Ceive\Net\Hypertext\Document\Exception\ProcessorEarlyException;
	...
	use Ceive\Value\Helper\HelperUserAgent;
	...
	class Agent extends Executor implements BrowserInterface, ClientInterface{
		...
		public function setUserAgent($user_agent = null){
			$this->user_agent = $user_agent;
			if($this->user_agent){
				$a = HelperUserAgent::parse($user_agent);
		 ...
		 * @param Request $request
		 * @param callable|null $then
		 * @return Response|ResponseInterface|DocumentInterface
		 */
